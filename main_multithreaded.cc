...
struct Triangle {
    ...
    explicit Triangle(int n) {
        ...
        std::vector<std::vector<int>> known_entries = {
            ...
            {0, 4, 8, X,11,11,11,11,11,11,11,11, 0},
            ...
            {0, 5, X, X, X, X, X,17,17,17,17,17,17,17,17,17,17,17, 0},
            {0, 5, X, X, X, X, X, X,18,18,18,18,18,18,18,18,18,18,18, 0},
            {0, 5, X, X, X, X, X, X, X,19,19,19,19,19,19,19,19,19,19,19, 0},
        };
